...
import { Vars } from "./BeforeAfter.sol";
...
abstract contract Logger {
  ...
  // function _log(Vars memory v) internal view {
  //     console.log(fixedLength(toString(v.placeholder)));
  // }

  // function _log(Vars memory _before, Vars memory _after) internal view {
  //     console.log(fixedLength(toString(_before.placeholder)));
  //     console.log(fixedLength(toString(_after.placeholder)));
  // }

  /*//////////////////////////////////////////////////////////////
                    General Methods
  //////////////////////////////////////////////////////////////*/
  function printBreak() internal view {
    if (ENABLED) {
      console.log("- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -");
      console.log("");
    }
